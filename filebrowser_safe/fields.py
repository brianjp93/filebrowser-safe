...
class FileBrowseWidget(Input):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        final_attrs['search_icon'] = fb_settings.URL_FILEBROWSER_MEDIA + 'img/filebrowser_icon_show.gif'
        final_attrs['directory'] = directory
        final_attrs['extensions'] = self.extensions
        final_attrs['format'] = self.format
        final_attrs['DEBUG'] = fb_settings.DEBUG
        return render_to_string("filebrowser/custom_field.html", dict(locals()))
